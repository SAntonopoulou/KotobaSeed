...
const DafniVerifyEmail = ({ tutor }) => {
  ...
  return (
    <DafniLayout
      ...
      onLogout={logout}
      variant="simple"
      setTitle={`Verify your email — Learn Greek with ${firstName}`}
    >
      <main className="d-form-page">
        <h1 className="d-pt">Check your inbox</h1>
        ...
        <div className="d-panel">
          <form onSubmit={handleSubmit}>
            <div className="d-field">
              <label className="d-field-label" htmlFor="dve-code">Verification code</label>
              <input
                id="dve-code"
                className="d-input"
                type="text"
            ...
            {info && <p className="d-form-success">{info}</p>}
            <button
              type="submit"
...
export default DafniVerifyEmail;
