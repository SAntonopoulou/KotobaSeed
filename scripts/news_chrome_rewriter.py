...
CTA_HTML = (
    ...
    '<span class="kb-cta-eyebrow">Colophon</span>'
    '<h2 class="kb-cta-title">'
    'Kotobaseed is the platform our writers also use to teach.'
    '</h2>'
    '<p class="kb-cta-sub">'
    'Hundreds of independent language tutors run their teaching '
    'practice here. Browse the library, or build your own.'
    '</p>'
